...
\userinformation{ % Set the content that goes into the sidebar of each page
  ...
  % \cvheading{Huy Nguyen}
  \cvheading{Huy}
  \cvheading{Nguyen}

  \cvsubheading{Cybersecurity Analyst} % Subheading - your occupation/specialization

  \Sep

  \textbf{Email} \faIcon{envelope} \\
  \href{mailto:nguyetuo@oregonstate.edu}{nguyetuo@oregonstate} \\
  ...
  \href{https://linkedin.com/in/huyngsec}{huyngsec} \\

  \Sep

  \textbf{GitHub} \faIcon{github} \\
  \href{\gh{smaugyXD}}{smaugyXD} \\

  \Sep

  \textbf{GitLab} \faIcon{gitlab} \\
  \href{\gl{smaugyXD}}{smaugyXD} \\
